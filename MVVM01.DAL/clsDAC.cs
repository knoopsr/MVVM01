...
namespace MVVM01.DAL
{
    public class clsDAC
    {
        ...
        private static string _MyConnenctionString = "Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=SchoolManager;Data Source=WINDOWS-JUT4M3I;TrustServerCertificate=True";
